...
# with command line options: step1 --filein file:gen.root --step=DIGI,L1,DIGI2RAW,HLT:2011 --datatier GEN-RAW --conditions=START53_LV6A1::All --fileout=hlt.root --eventcontent RAWSIM --python_filename hlt_cfg.py --number=10 --mc --no_exec
